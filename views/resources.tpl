...
<div class="page-header">
  <h1>(coming soon...)Getting started</h1>
  <hr>
  <h2>Connecting to an existing Linux machine <small>...via SSH<p>(NOTE: Unix/Linux does not show your password at all as you type it.)</small></h2>
